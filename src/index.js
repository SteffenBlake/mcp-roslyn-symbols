    ...
    setupHandlers() {
            ...
            const tools = [
                {
                    ...
                    description: 'Gets symbol information for a type at a specific cursor position in a C# file. ' +
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            if (request.params.name === 'get_symbols_for') {
                return await this.handleGetSymbolsFor(request.params.arguments);
            }
            throw new Error(`Unknown tool: ${request.params.name}`);
        });
    }
    async handleGetSymbolsFor(args) {
        try {
